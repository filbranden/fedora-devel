...
RUN dnf -y install fedora-packager fedora-review koji krb5-workstation util-linux man man-pages git vim wget '@Development Tools' '@C Development Tools and Libraries'
